      ...
      <div class="flex items-center justify-between">
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] dark:bg-gray-800">
          <div class="flex items-center justify-between mb-4">
            <div class="text-lg font-700 text-gray-900 dark:text-white">User Growth</div>
          ...
          <div v-else class="grid grid-cols-3 gap-4">
            <div>
              ...
              <div class="text-2xl font-700 text-gray-900 dark:text-white">{{ userGrowth.this_month }}</div>
            </div>
            <div>
              <div class="text-sm text-gray-600 dark:text-gray-300 mb-1">Last Month</div>
              <div class="text-2xl font-700 text-gray-900 dark:text-white">{{ userGrowth.last_month }}</div>
            </div>
            <div>
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] dark:bg-gray-800">
          <div class="flex items-center justify-between mb-4">
            <div class="text-lg font-700 text-gray-900 dark:text-white">Content Activity</div>
          ...
          <div v-else class="grid grid-cols-3 gap-4">
            <div>
              ...
              <div class="text-2xl font-700 text-gray-900 dark:text-white">{{ contentActivity.last_7_days }}</div>
            </div>
            <div>
              <div class="text-sm text-gray-600 dark:text-gray-300 mb-1">Last 30 Days</div>
              <div class="text-2xl font-700 text-gray-900 dark:text-white">{{ contentActivity.last_30_days }}</div>
            </div>
            <div>
              <div class="text-sm text-gray-600 dark:text-gray-300 mb-1">Total Images</div>
              <div class="text-2xl font-700 text-gray-900 dark:text-white">{{ contentActivity.total }}</div>
            </div>
          </div>
        </div>
        ...
        <!-- Top Tags -->
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] dark:bg-gray-800">
          <div class="text-lg font-700 text-gray-900 dark:text-white mb-4">Most Used Tags</div>
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] dark:bg-gray-800">
          ...
          <div v-else class="space-y-3">
            <NuxtLink v-for="(image, index) in topImages" :key="image.id" :to="`/illustrations/${image.slug}`"
              ...
              <div
                class="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center font-700 text-sm flex-shrink-0">
                {{ index + 1 }}
              </div>
              <div class="flex-1 min-w-0">
                <div class="font-600 text-gray-900 dark:text-white truncate">{{ image.name }}</div>
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] dark:bg-gray-800">
          ...
          <div v-else class="space-y-3">
            <NuxtLink v-for="(collection, index) in topCollections" :key="collection.id"
              ...
              <div class="flex-1 min-w-0">
                <div class="font-600 text-gray-900 dark:text-white truncate">{{ collection.name }}</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">
