  ...
  <header :class="[isScrolled ? 'scrolled' : '', 'sm:hidden w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-b b-dashed border-gray-200 dark:border-gray-700 sticky top-0 z-12']">
    <div class="flex items-center justify-center px-4 py-3 safe-area-pt">
      ...
      <div class="flex flex-col items-center">
        <h1 class="font-title leading-tight font-200 text-gray-800 dark:text-gray-100 mobile-title">
          <NuxtLink
            to="/about"
        ...
        <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400 mobile-desc">
          A small gallery of bold illustrations & curated images — browse and collect.
        </p>
      </div>
    </div>
  </header>
...
header .mobile-desc {
  ...
  max-height: 48px; /* enough for one line of small text */
  overflow: hidden;
}
