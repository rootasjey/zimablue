    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
      ...
      >
        <div class="absolute top-2 right-2 z-10">
          <span class="i-ph-dots-six-vertical text-gray-200 drop-shadow-lg"></span>
        </div>
        
        <!-- Order indicator -->
        <div class="absolute top-2 left-2 z-10">
          <span class="bg-black bg-opacity-60 text-gray-200 text-xs px-2 py-1 rounded">
            {{ index + 1 }}
          </span>
        </div>
        ...
        >
          <div class="flex flex-col gap-1 items-center text-gray-200 font-medium">
