      ...
      <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4">
          <div>
            ...
            <div class="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <span class="text-sm text-gray-900 dark:text-gray-200">{{ message.sender_email }}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <span class="text-sm text-gray-900 dark:text-gray-200">{{ formatFullDate(message.created_at) }}</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <h4 class="text-base font-semibold text-gray-900 dark:text-gray-200">
              {{ message.subject }}
            </h4>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg max-h-96 overflow-y-auto">
            <div 
              class="text-sm text-gray-900 dark:text-gray-200 whitespace-pre-wrap leading-relaxed"
