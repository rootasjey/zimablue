<template>
  ...
  <button
    ...
    class="fixed top-4 left-4 z-50 w-12 h-12 bg-black rounded-xl flex items-center justify-center text-gray-200 hover:bg-gray-900 transition-colors md:hidden"
    ...
    >
      ...
      <div class="flex items-center justify-center py-6 px-4">
        <NLink to="/" class="w-14 h-14 bg-white rounded-2xl flex items-center justify-center">
          <span class="text-gray-900 text-xl font-bold">zb</span>
        </NLink>
      </div>
      ...
      <nav class="flex-1 flex flex-col items-center gap-2 px-4 py-4">
        ...
        >
          <NuxtLink
            :to="item.path"
            @click="closeMobileMenu"
            class="nav-item relative w-full flex justify-center items-center gap-3 px-4 py-3 rounded-xl text-gray-200/70 hover:text-gray-200 hover:bg-white/10 transition-all"
            :class="{ 'bg-white/20 text-gray-200': isItemActive(item) }"
          >
            ...
            <span
              ...
              class="absolute top-2 right-2 min-w-[20px] h-5 px-1.5 bg-red-500 text-gray-200 text-xs font-bold rounded-full flex items-center justify-center"
            >
      ...
      <div class="px-4 py-4 border-t border-white/10">
        <NTooltip :_tooltip-content="{
          ...
          <NuxtLink
            to="/admin/settings"
            @click="closeMobileMenu"
            class="nav-item w-full flex justify-center items-center gap-3 px-4 py-3 rounded-xl text-gray-200/70 hover:text-gray-200 hover:bg-white/10 transition-all"
            :class="{ 'bg-white/20 text-gray-200': isActive('/admin/settings') }"
          >
