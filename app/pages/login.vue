<template>
  <div class="min-h-96vh flex flex-col lg:flex-row">
    ...
    <div class="hidden rounded-2xl lg:flex lg:w-1/2 relative bg-[#0066CC] overflow-hidden">
      ...
      <!-- Content -->
      <div class="relative z-10 flex flex-col justify-between p-12 text-gray-200">
        <div>
    ...
    <div class="flex-1 flex flex-col bg-white dark:bg-gray-900">
      ...
      <div class="flex flex-col items-center lg:hidden p-4 border-b border-dashed border-gray-100 dark:border-gray-800">
        ...
        <span class="mt-2 font-body text-size-6 font-600 text-gray-900 dark:text-gray-200">Zima Blue</span>
      </div>
          ...
          <div class="w-full max-w-sm form-card">
            ...
            <Transition name="form-swap" mode="out-in">
              <div :key="isLogin ? 'login' : 'signup'">
                <!-- Header -->
                <div class="mb-6">
                  <h1 class="text-2xl font-400 text-gray-900 dark:text-gray-200">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-4" key="form">
                  ...
                  <div v-if="!isLogin">
                    ...
                    <div class="relative">
                      <NInput
                        ...
                        required
                        leading="i-ph-user"
                        class="w-full pl-10 pr-4 py-5.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all"
                      />
                    </div>
                  </div>
                    ...
                    <div v-if="!isLogin && showOptionalFields" class="space-y-4 pt-2">
                      <div>
                        ...
                        <NInput
                          ...
                          rows="2"
                          class="w-full px-4 py-5.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all resize-none"
                        />
                      </div>
                      <div class="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <NInput
                            ...
                            class="w-full px-4 py-5.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all"
                          />
                        </div>
                        <div>
                  ...
                  <Transition name="fade">
                    <div v-if="error" class="flex items-center gap-2 p-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 rounded-xl text-sm text-red-600 dark:text-red-400">
                      ...
                      <span>{{ error }}</span>
                      <button type="button" @click.stop="error = ''" aria-label="Close error" class="ml-auto i-ph-x hover:text-red-800 dark:hover:text-red-300"></button>
                    </div>
                  </Transition>
                  ...
                  <button
                    ...
                    class="w-full py-3 px-4 bg-gradient-to-r from-[#0077CC] via-sky-500 to-cyan-400 text-gray-200 font-medium rounded-xl hover:from-[#0066BB] hover:via-sky-600 hover:to-cyan-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 shadow-lg shadow-sky-500/25 hover:shadow-sky-500/40"
                  >
