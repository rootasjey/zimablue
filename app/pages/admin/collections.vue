  ...
  <div>
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl sm:text-3xl font-700 text-gray-900 dark:text-gray-200">Collection Management</h1>
          ...
          <template #name-cell="{ cell }">
            <div class="flex items-center gap-3">
              <div class="w-12 h-12 bg-black rounded-lg border border-gray-200 dark:border-gray-700 flex items-center justify-center">
                <span class="i-ph-folder text-gray-200"></span>
              </div>
              <div class="min-w-0">
          ...
          <template #user_name-cell="{ cell }">
            <div class="flex items-center gap-2">
              <div class="w-6 h-6 bg-black rounded-full flex items-center justify-center">
                <NIcon name="i-ph-user" size="xs" class="text-gray-200" />
              </div>
              <div class="min-w-0">
                <p class="text-sm font-medium text-gray-900 dark:text-gray-200 truncate">{{ cell.getValue() }}</p>
    ...
    <NDialog v-model:open="isViewDialogOpen" title="Collection Details">
      <div v-if="selectedCollection" class="p-6">
        <div class="space-y-6">
          <!-- Collection Info -->
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-200">{{ selectedCollection.name }}</h3>
    ...
    <NDialog v-model:open="isDeleteDialogOpen" title="Delete Collection">
      <div class="p-6">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-200">Delete Collection</h3>
