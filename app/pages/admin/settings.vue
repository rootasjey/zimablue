  ...
  <div>
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl sm:text-3xl font-700 text-gray-900 dark:text-gray-200">Settings</h1>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] border border-[#b7cbd8] dark:bg-gray-800 dark:border-transparent">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-xl bg-black flex items-center justify-center">
              <span class="i-ph-palette text-gray-200 text-xl"></span>
            </div>
            <h2 class="text-xl font-700 text-gray-900 dark:text-gray-200">Appearance</h2>
          </div>
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] border border-[#b7cbd8] dark:bg-gray-800 dark:border-transparent">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-xl bg-black flex items-center justify-center">
              <span class="i-ph-user text-gray-200 text-xl"></span>
            </div>
            <h2 class="text-xl font-700 text-gray-900 dark:text-gray-200">Profile</h2>
          </div>
        ...
        <div class="rounded-[28px] p-6 bg-[#D1E0E9] border border-[#b7cbd8] lg:col-span-2 dark:bg-gray-800 dark:border-transparent">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-xl bg-black flex items-center justify-center">
              <span class="i-ph-lock text-gray-200 text-xl"></span>
            </div>
            <h2 class="text-xl font-700 text-gray-900 dark:text-gray-200">Security</h2>
          </div>
