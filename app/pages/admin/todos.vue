  ...
  <div>
    ...
    <div v-else class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-700 text-gray-900 dark:text-gray-200">To-Do List</h1>
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <button
              ...
              :class="todo.status === 'completed' ? 'bg-emerald-500 text-gray-200' : 'bg-white border-2 border-gray-300 hover:border-gray-400'"
            >
    ...
    <NDialog v-model:open="isDialogOpen">
      <div class="p-6">
        <h2 class="text-2xl font-700 text-gray-900 dark:text-gray-200 mb-4">
    ...
    <NDialog v-model:open="isDeleteDialogOpen">
      <div class="p-6">
          <h2 class="text-2xl font-700 text-gray-900 dark:text-gray-200 mb-4">Delete Task</h2>
