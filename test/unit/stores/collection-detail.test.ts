...
describe('useCollectionDetailStore', () => {
  ...
  describe('addImageObjects', () => {
    it('adds normalized images to the collection', () => {
      const store = useCollectionDetailStore()
  ...
  describe('updateImageInCollection', () => {
    it('updates an existing image in the collection', () => {
      const store = useCollectionDetailStore()
  ...
  describe('removeDeletedImage', () => {
    it('removes an image and updates count', () => {
      const store = useCollectionDetailStore()
    ...
    it('clears cover_image_id if it matches deleted image', () => {
      const store = useCollectionDetailStore()
