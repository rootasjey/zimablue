  ...
  shortcuts: [
    {
      ...
      "admin-nav-item-active": "bg-indigo-500 text-white hover:bg-indigo-400 hover:text-white shadow-sm shadow-indigo-500/30",
      "admin-badge": "inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium",
      "admin-badge-indigo": "admin-badge bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-400",
